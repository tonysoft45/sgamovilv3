...
public class salidaporotrosconceptos extends AppCompatActivity {

    WebView wv_1;

    private static String DIRECCION_HOST = "";
    private static String UBICACION = "";
    private static String PAGINA = "/api/salidaporotrosconceptos_detalles.api.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_salidaporotrosconceptos);
